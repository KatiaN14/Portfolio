          ...
          <table className="w-full text-left border-collapse min-w-[600px]">
            ...
            <tbody className="text-sm md:text-base align-top">
              <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors group">
                <td className="py-5 px-4 font-semibold text-gray-900 group-hover:text-gmvRed transition-colors">{t.catData}</td>
              ...
              <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors group">
                <td className="py-5 px-4 font-semibold text-gray-900 group-hover:text-gmvRed transition-colors">{t.catProg}</td>
              ...
              <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors group">
                <td className="py-5 px-4 font-semibold text-gray-900 group-hover:text-gmvRed transition-colors">{t.catFront}</td>
              ...
              <tr className="border-b border-gray-100 hover:bg-gray-50 transition-colors group">
                <td className="py-5 px-4 font-semibold text-gray-900 group-hover:text-gmvRed transition-colors">{t.catBiz}</td>
